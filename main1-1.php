                    ...
                    <div class="content">
                        ...
                        <div class="gallery-controller">
                            <ul class='clearfix'>
                                <li><!-- 왼쪽 박스 -->
                                    <div class="page-wrap">
                                        <div class="prev-btn-wrap"><a href="javascript:" class="prev-btn" title="Priew Button"><img src="./img/main1/main1-1/prev-first.png" alt="Priew Button"></a></div>
                                        <ul class='page-btn-wrap clearfix'> <!-- 페이지 버튼 박스 -->
                                            <li><a href="javascript:" class="page-btn page-btn0">1</a></li>
                                            <li><a href="javascript:" class="page-btn page-btn1">2</a></li>
                                            <li><a href="javascript:" class="page-btn page-btn2">3</a></li>
                                            <li><a href="javascript:" class="page-btn page-btn3">4</a></li>
                                            <li><a href="javascript:" class="page-btn page-btn4">5</a></li>
                                        </ul>
                                        <div class="next-btn-wrap"><a href="javascript:" class="next-btn" title="Next Button"><img src="./img/main1/main1-1/next-last.png" alt="Next Button"></a></div>
                                    </div>
                                </li>
                                <li><!-- 오른쪽 박스 -->
                                    <div class="find-wrap" tabindex='0'>
                                        <div class="input-wrap"> <!-- 입력상자 -->
                                            <input type="text" name='search' id='search' placeholder='검색어를 입력하세요'>
                                        </div>
                                        <div class='button-wrap'> <!-- 검색버튼 -->
                                            <a href="javascript:" class="search-btn" title='Search Button'><img src="./img/main1/main1-1/search_i_02.png" alt="Search"></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="container">
                    ...
                    <div class="content">
                        <div class="slide-container">
                            <div class="slide-view"> <!-- 1348.8 -->
                                <ul class="slide-wrap"> <!-- (424*9)+((424*(1.2))-424) -->
                                    <li class="slide slide0"> <!-- 424 * 464 -->
                                        <div class="slide-gap"> <!-- 0 20 -->
                                            <div class="slide-content"> <!-- 383 * 464 -->
                                                <div class="content-gap"> <!-- 50  -->
                                                    <div class="content-box"> <!-- 284 * 195.95 -->
                                                ...
                                                <div class="content-gap">
                                                    <div class="content-box">
                                                        ...
                                                        <p>
                                                            ...
                                                            다낭(Da Nang)에서 남쪽으로 30km 역사적인 도시인 호이안에서 북쪽으로 11km 거리에 위치해 있는 남하이는 60개의 아름다운 빌라와 
                                                            40개의 풀빌라를 갖추고 있으며 각각의 객실은 베트남 고유의 풍경을 보여주는 정원과 South Chian Sea 뷰를 뽐내며 Cham 아일랜드 근처에 위치하고 있습니다.
                                                        </p>
                                                        <h5>explore &gt;</h5>
                                                    </div>
                                                </div>
                            ...
                            <span class="next-btn-wrap"><a href="javascript:" class="next-btn" title='Next Button'><img src="./img/main1/main1-1/slick-next1.png" alt="Next Button"></a></span>
                            <span class="prev-btn-wrap"><a href="javascript:" class="prev-btn" title='Preview Button'><img src="./img/main1/main1-1/slick-prev1.png" alt="Preview Button"></a></span>
                        </div><!-- slide-container -->
                    </div>
